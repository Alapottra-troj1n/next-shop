            ...
            <section className="text-gray-600 body-font overflow-hidden">
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                     <div className="relative h-[40rem] w-96">
                     <Image layout='fill' src={product.img}  objectFit='cover' objectPosition='top center' alt={product.title} />
                     </div>
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex">
                                ...
                                <button onClick={() => addToCart(122, 1, 455, `${product.title}`, `${product.size}`, 'Red')} className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Add to Cart</button>

                                <Link href={'/checkout'} ><button className=" text-white mx-3 bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Checkout</button></Link>
